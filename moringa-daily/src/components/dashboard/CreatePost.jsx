...
import Upload from "./components/dashboard/Upload"; // Import the Upload component
      ...
      <div className="grid grid-cols-1 md:grid-cols-5">
        ...
        <div className="col-span-1 md:col-span-2 mx-8">
          ...
          <div className="mb-3">
            ...
            <Upload /> {/* Render the Upload component here */}
          </div>
          <div className="mb-3">
...
//   useEffect(() => {
//     const cloudinaryRef = window.cloudinary;
//     widgetRef.current = cloudinaryRef.createUploadWidget(
//       {
//         cloudName: "dkwurmldt",
...
//     widgetRef.current.open(); // Opens the Cloudinary upload widget
//   };
...
//       <div className='mb-3'>
//         <h6 className='text-default-gold py-2 text-md'>Upload Features Image</h6>
//         <button onClick={handleImageUpload} className='rounded py-1'>
//           Upload Image
//         </button>
//       </div>
//       {/* ... more of your JSX ... */}
