...
const UsersList = () => {
  ...
  const deleteUser = (userId) => {
    // Make a DELETE request to your backend API to delete the user by userId
  ...
  const approveUser = (userId) => {
    // Make a PUT request or any other appropriate request to approve the user
    // You can use axios or any other method to send the request
    axios
      .put(`http://localhost:5000/users/approve/<int:user_id>`)
      .then((response) => {
